 ...
 * (см. {@link Component}) относящихся к одному и тому же условному игровому объекту. Данный класс
 * является value-object. Объекты данного класса не изменяемы.
 */
public final class Entity {
    ...
    /**
     * Возвращает идентификато типа данной сущности.
     ...
     * @return кол-во переиспользований ID, который в данный момент является персональным ID данной сущности.
     */
