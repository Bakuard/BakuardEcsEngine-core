...
public final class SystemManager {
     ...
     * систем прослушивающих события этого же типа.
     * <br/><br/>
     ...
     * вызова этого метода.
     * @param systemID идентификатор системы подписываемой на рассылку события указанного типа.
     ...
     * @throws IllegalArgumentException генерирует по одной из следующих причин: <br/>
