 ...
 * 3. Вызывается метод update() у всех систем ввода в порядке убывания их приоритетов. <br/>
 * 4. Вызывается метод update() у всех систем логики в порядке убывания их приоритетов. <br/>
...
public final class GameLoop {
     ...
     * цикла в этом потоке, для всех систем будет выполнено фактическое добавление или удаление из списка
     * обрабатываемых систем и следующим шагом для всех систем в игровом мире будет вызван метод start() в следующем
     * порядке: <br/>
     * 1. Для всех систем ввода в порядке убывания их приоритетов. <br/>
     * 2. Для всех систем логики в порядке убывания их приоритетов. <br/>
     * 3. Для всех систем рендера в порядке убывания их приоритетов. <br/>
     ...
     * <br/><br/>
     * Метод stop() вызывается у всех систем в следующем порядке: <br/>
     * 1. Для всех систем ввода в порядке убывания их приоритетов. <br/>
     * 2. Для всех систем логики в порядке убывания их приоритетов. <br/>
     * 3. Для всех систем рендера в порядке убывания их приоритетов. <br/>
