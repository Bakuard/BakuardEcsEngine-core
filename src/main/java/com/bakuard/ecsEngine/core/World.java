...
/**
 * Данный класс представляет собой игровой мир. Каждый игровой мир представляет собой отдельный и независимый
 * уровень игры. Отдельный игровой мир хранит все данные связанные с одним конкретным уровнем игры. Каждый
 * игровой мир хранит свой менеджер сущностей и компонентов, менеджер систем, а также объект предоставляющий
