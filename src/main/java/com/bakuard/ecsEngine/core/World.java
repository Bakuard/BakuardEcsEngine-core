...
public final class World {
    ...
    /**
     * Данный класс реализует паттерн "Builder". Объекты данного класса испльзуются для предварительной настройки и
     * создания объектов {@link World}. Все настраиваемые параметры и их значения по умолчанию представлены ниже:
     * 1. частота обновлений игровой логики в секунду - 40
     * 2. максимальное кол-во дополнительных обновлений игрвой логики - 10
     * 3. Кол-во портов для событий систем - 256.
     * Подроьная информация для каждого параметра представлена в API к методу класса Builder задающего значение этого
     * параметра.
     */
    public static final class Builder {
         ...
         */
        public Builder() {
            numberUpdatePerSecond = 40;
            maxFrameSkip = 10;
            numberPorts = 256;
        }

        /**
         * Настройки для игрового цикла. Устанавливает предпочтительное кол-во обновлений всей игровой логики
         * в секунду. Фактическое кол-во обновлений игровой логики гарантированно не будет больше заданного значения,
         * но может быть меньше его.
         *
        ...
        /**
         * Настройки для игрвого цикла. В случае, если игровой цикл не успевает обработать игровую логику
         * с задананной частотой, он будет пытаться на каждом своем шаге (подробнее см. {@link GameLoop}) выполнить
         * несколько дополнительных обновлений игровой логики, чтобы нагнать отставание от заданной частоты. Однако
         * если игровой цикл будет стабильно отставать от заданной частоты при каждом обновлении игровой логики, но
         * кол-во дополнительных обновлений игровой логики, которые ему предстоит сделать на следующем шаге будет
         * постоянно расти. Данный метод задает максимальное кол-во дополнительных обновлений игровой логики на каждом
