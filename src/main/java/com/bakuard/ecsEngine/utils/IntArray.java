...
public final class IntArray {
    ...
    /**
     * Добавляет указанный элемент в массив сохраняя заданный порядок элементов. Если массив содержит
     * несколько элементов с тем же значением, что и добавляемый элемент - метод не дает гарантий, куда
     * будет вставлен элемент оносительно элементов с тем же значением. Выполняет вставку элемента с
     * использованием двоичного поиска.
     ...
     */
    public void binaryInsert(int value, IntComparator comparator) {
        ++actualModCount;
        ...
        if(fromIndex == toIndex) insert(fromIndex, value);
        else insert(middle, value);
    }
